...
<body>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="admin-autform" class="mb-3" action="" method="POST">
                            @csrf
                            <div class="mb-3">
    ...
    {{-- <script src="{{ asset('admin/admin-auth.js') }}"></script> --}}
    ...
    $('#admin-autform').submit(function(event) {
        ...
        var adminAuthLoginUrl = "{{route('admin-auth')}}";
